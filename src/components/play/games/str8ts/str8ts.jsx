import styles from './str8tsStyle.module.css'
...
export default function Str8ts() {
            ...
            if (key === "Enter") {
                if (col === solutionLength) {
                    ...
                    for (let i = 0; i < solutionLength; i++) {
                        if (result[0][i]) {
                            let status = (result[1]) ? result[0][i].status + " solved" : result[0][i].status
    ...
    return (
        <>
            <div className={styles.Str8tsGame}>
            <h1>Str8ts</h1>
                <div className="hud">
                ...
                <div className={styles.game}>
                    {isGameOver ? <div id="overlay">
                        {isGameOver === "loss" ? "You lost" : "Win"}</div>
                        : null}
                    <div id="board" className={isGameOver ? styles.over : ""}>
